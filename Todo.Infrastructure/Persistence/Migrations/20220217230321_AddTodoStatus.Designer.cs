...
namespace Todo.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20220217230321_AddTodoStatus")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Todo.Domain.Enums.TodoStatusEntity", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int")
                        .HasColumnName("TodoStatusId");
                    ...
                    b.ToTable("TodoStatus", (string)null);
                });
            ...
            modelBuilder.Entity("Todo.Domain.Entities.TodoEntity", b =>
                {
                    b.HasOne("Todo.Domain.Enums.TodoStatusEntity", "StatusEntity")
                        .WithMany("Todos")
